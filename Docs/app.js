function styleAllElementsWithTailwindAndDaisyUI() {
    ...
    const elements = [
        ...
        { selector: "h1", classes: "font-title text-center text-[clamp(2rem,6vw,4.2rem)] font-black leading-[1.1] [word-break:auto-phrase] xl:w-[115%] xl:text-start [:root[dir=rtl]_&]:leading-[1.35] text-primary pt-12 mt-12 underline" },
        { selector: "h2", classes: "text-2xl md:text-2xl font-bold text-primary mb-2 mt-10 leading-snug" },
        { selector: "h3", classes: "text-xl md:text-xl font-medium mt-4 mb-3 leading-snug" },
        { selector: "h4", classes: "text-lg md:text-lg font-medium mb-1 mt-3 leading-snug" },
        { selector: "p", classes: "text-base md:text-md leading-relaxed mb-4" },
        ...
        { selector: ".badge", classes: "badge badge-primary text-xs px-3 py-1 rounded-full" },
        ...
        { selector: "code", classes: "text-primary font-semibold" },
...
function setupLayout() {
    ...
    content.className = "flex-1  px-10 rounded-lg shadow-md ml-0 lg:ml-64 overflow-y-auto";
    content.innerHTML = `
